...
fn integration_challenge_01() {
    let hexadecimal = Bytes::from_hex_literal(
...
fn integration_challenge_01_reverse() {
    let base64 = Bytes::from_base64_literal(
        "SSdtIGtpbGxpbmcgeW91ciBicmFpbiBsaWtlIGEgcG9pc29ub3VzIG11c2hyb29t",
    );
...
fn integration_challenge_02() {
    let plain = Bytes::from_hex_literal("1c0111001f010100061a024b53535009181c");
    let key = Bytes::from_hex_literal("686974207468652062756c6c277320657965");
...
fn integration_challenge_03() {
    ...
    let expected_result =
        Bytes::from_unicode_literal("Cooking MC's like a pound of bacon");
...
fn integration_challenge_04() {
    ...
    let expected_result = Bytes::from_unicode_literal("Now that the party is jumping\n");
    ...
    let best_score =
        all_strings_hex
            ...
            .fold(initial_score, |best_score, string_hex| {
                let cypher = Bytes::from_hex_literal(string_hex);
                let mut scores = cryptopals::find_lowest_score_xor(&cypher);
...
fn integration_challenge_05() {
    ...
    let key = Bytes::from_unicode_literal("ICE");
...
fn integration_challenge_06() {
    ...
    let expected_result = Bytes::from_unicode_literal("Terminator X: Bring the noise");
    ...
    let result_key = transposed_blocks
        .iter()
        .fold(Bytes::default(), |mut acc, block| {
